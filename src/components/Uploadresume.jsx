...
//     const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MjUsImVtYWlsIjoidGVzdGluZzVAbWFpbC5jb20iLCJleHAiOjE3MTkzMjI0NDh9.l7aAO3UvpJfJgkydT8ob3fNKJg23qaxvDEDXWSltgDQ"; 
...
function Uploadresume() {
  ...
  useEffect(() => {
    ...
    const storedToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MzcsImVtYWlsIjoidGVzdGluZzdAbWFpbC5jb20iLCJleHAiOjE3MTkzNDIyMDF9.ZbOvcfz3iILxt7BstNl9rRrjtbPWg2LJk_NMBnJi124";
    if (storedToken) {
