...
function Uploadresume() {
  ...
  const handleUpload = async () => {
    ...
    const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MzcsImVtYWlsIjoidGVzdGluZzdAbWFpbC5jb20iLCJleHAiOjE3MTkzMjAwOTR9.ldks58WpCwOMk6PHf9OOL28VpR5-UHwSD6lqGkgMkpc"; 
    console.log(token);
